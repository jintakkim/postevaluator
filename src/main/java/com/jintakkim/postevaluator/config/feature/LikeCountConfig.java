...
public class LikeCountConfig {
    ...
    public LikeCountConfig(long median, double std, String criteria) {
        if (median < 0 || std < 0) {
    ...
    public static LikeCountConfig.Builder builder() {
        return new LikeCountConfig.Builder();
    }

    public String getFeatureDescription() {
        return String.format("좋아요수이다, 통계적 특성: %s", distribution.getDescription());
    }
    ...
    public static class Builder {
        ...
        public LikeCountConfig.Builder criteria(String criteria) {
            this.criteria = criteria;
            return this;
        }

        public LikeCountConfig.Builder median(long median) {
            this.median = median;
            return this;
        }

        public LikeCountConfig.Builder std(double std) {
            this.std = std;
            return this;
        }

        public LikeCountConfig build() {
            if(median == null) {
                log.warn("좋아요수 중앙값이 설정되지 않아 {}으로 설정합니다", DEFAULT_MEDIAN);
            ...
            return new LikeCountConfig(median, std, criteria);
        }
    }
}
