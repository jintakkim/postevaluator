...
public final class MapperUtils {
     ...
     */
    public static Map<String, Object> extractFields(ResultSet rs, Set<String> excludeFields, EntitySchema entitySchema) throws SQLException {
        ...
        for (int i = 1; i <= columnCount; i++) {
            ...
            ColumnDefinition columnDefinition = entitySchema.getColumnDefinitionElseThrow(columnName);
            Object field = rs.getObject(i, columnDefinition.type().getJavaType());
     ...
     */
    public static Map<String, Object> extractFieldsByAlias(ResultSet rs, String alias, Set<String> excludeFields, EntitySchema entitySchema) throws SQLException {
        ...
        for (int i = 1; i <= colCount; i++) {
            ...
            if (label.startsWith(prefix)) {
                ...
                ColumnDefinition columnDefinition = entitySchema.getColumnDefinitionElseThrow(camelName);
                Object value = rs.getObject(i, columnDefinition.type().getJavaType());
