...
public class DatabaseSynchronizerTest extends LocalFileDbIntegrationTest {
    ...
    void synchronizeWhenFeaturesHaveChangedShouldRecreateTables() {
        rollbackTest((handle) -> {
            PostDatabaseSynchronizer updatedTableSynchronizer = new PostDatabaseSynchronizer(jdbi, TestFeatureDefinitionProviderGenerator.generate(FEATURES_TO_CHANGE));
